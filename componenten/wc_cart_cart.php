...
<div class="container grid md:grid-cols-2 gap-3">

<div class="">

<h2 class="text-green text-40 leading-40 md:text-60 md:leading-60 lg:text-70 lg:leading-70 font-frederick-normal mt-12 mb-3">Overzicht</h2>
...
<?php do_action( 'woocommerce_after_cart' ); ?>
    ...
    <div class="my-12">
        <h2 class="text-green text-40 leading-40 md:text-60 md:leading-60 font-frederick-normal">Afrekenen</h2>
        <div class="mt-3">
