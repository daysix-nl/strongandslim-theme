...
<hr class="border-white my-3">
	...
	<script>
		...
		<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="text-18 leading-18 block py-1.5 px-3 bg-soft-peache border-2 border-soft-peache rounded-full transition-colors text-white hover:bg-white hover:text-soft-peache hover:border-white hover:transition-colors w-fit"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
