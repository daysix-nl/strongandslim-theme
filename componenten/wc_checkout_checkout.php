...
<h2 class="text-green text-40 leading-40 md:text-60 md:leading-60  font-frederick-normal mt-4 md:mt-4 mb-3">Overzicht</h2>
...
<?php do_action( 'woocommerce_after_cart' ); ?>
    ...
    <div class="my-4 md:my-4 mb-8 md:mb-[unset]">
