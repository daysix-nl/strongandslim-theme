...
var imageTop = document.getElementsByClassName("image-top");
new simpleParallax(imageTop, {
  overflow: true,
  transition: "cubic-bezier(0,0,0,1)",
  orientation: "up",
  maxTransition: 50,
...
var imageBottom = document.getElementsByClassName("image-bottom");
new simpleParallax(imageBottom, {
  overflow: true,
  transition: "cubic-bezier(0,0,0,1)",
  orientation: "down",
  maxTransition: 50,
