...
<section class="relative <?php the_field('basis_achtergrond');?> overflow-hidden">
    <div class="absolute left-0 top-0 h-full md:w-[10s0vw] overflow-hidden acf-home-hero-achtergrond">
    ...
    <section class="grid md:grid-cols-2  h-[300px] md:h-[400px] hero-home relative container">
        <div class="col-span-1 relative flex items-center h-[300px] md:h-[400px] w-full overflow-hidden ">
            <div class="relative z-[2] flex flex-col h-full justify-center">
                ...
                <p class="flex flex-row items-center  text-white text-15 mb-4 mt-auto"><a href="/">Home</a> <span class="w-[4px] h-[4px] rounded-full bg-white block mx-1"></span> <a href="/blog">Blog</a> <span class="w-[4px] h-[4px] rounded-full bg-white block mx-1"></span> <a href=""><?php the_title(); ?></a></p>
            </div>
        </div>
    </section>
</section>
